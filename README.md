...
## The Iconary Advantage

| Feature | Description |
| :--- | :--- |
| **Purpose-Built for AI** | Hand-crafted visuals for concepts like *RAG Architecture*, *Embeddings*, *Vector Databases*, and *Intelligent Agents*. |
| **Three distinct styles** | Instantly switch between `outline`, `filled`, and dynamic `duotone` variants from a single source. |
| **Framework Ready** | Native, tree-shakeable packages for React and Vue, with Svelte and a Figma Plugin coming soon. |
| **Performance First** | Heavily minified via SVGO for zero-bloat, lightning-fast load times. |
| **Built-in Explainers** | Demystify the tech—every icon is paired with a clear, 1-2 sentence concept explanation. |
...
<details>
<summary><b>Plain HTML/SVG</b></summary>
<br/>
...
* **Draw:** Follow the style guide, create an SVG, add it to the registry, and open a PR.
* **Explain:** Refine or translate the plain-English explanations attached to each icon concept.
* **Build:** Enhance our build pipeline, improve TypeScript typings, or expand framework support.

**Get Started:** Read our [Contribution Guidelines (CONTRIBUTING.md)](./CONTRIBUTING.md).  
**Find an Issue:** Check out issues labeled [`good first issue`](https://github.com/pradhan-not-found/Iconary/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) or [`help wanted`](https://github.com/pradhan-not-found/Iconary/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22).
