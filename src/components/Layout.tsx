      ...
      <header className="sticky top-0 z-50 w-full h-[80px] border-b border-[#333] bg-[#1a1a1a]">
        <nav className="max-w-6xl mx-auto w-full h-full flex items-stretch justify-between border-l border-r border-[#333]">
          ...
          <div className="hidden md:flex items-stretch border-l border-[#333]">
            ...
            <Link to="/#contribute" className="flex items-center px-6 py-3.5 text-[1.25rem] text-[#a3a3a3] transition-colors hover:text-white border-r border-[#333] font-display">Contribute</Link>
            <Link to="/#faq" className="flex items-center px-6 py-3.5 text-[1.25rem] text-[#a3a3a3] transition-colors hover:text-white border-r border-[#333] font-display">FAQ</Link>
