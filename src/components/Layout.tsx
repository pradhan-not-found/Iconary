...
export function Layout() {
  ...
  return (
    <div className="w-full">
      ...
      <header className="sticky top-0 z-50 w-full h-[64px] border-b border-[#333] bg-[#1a1a1a]">
        <nav className="max-w-6xl mx-auto w-full h-full flex items-stretch justify-between border-l border-r border-[#333]">
          <div className="flex items-stretch border-r border-[#333]">
            <Link to="/" className="flex items-center px-6 py-3.5 text-[2rem] leading-none mt-1 text-white font-brand tracking-normal">
              Iconary
            </Link>
          </div>
          
          <div className="hidden md:flex items-stretch border-l border-[#333]">
            <Link to="/browse" className="flex items-center px-5 py-3.5 text-[0.95rem] text-[#a3a3a3] transition-colors hover:text-white border-r border-[#333]">Browse</Link>
            <Link to="/docs" className="flex items-center px-5 py-3.5 text-[0.95rem] text-[#a3a3a3] transition-colors hover:text-white border-r border-[#333]">Docs</Link>
            <a href="/#contribute" className="flex items-center px-5 py-3.5 text-[0.95rem] text-[#a3a3a3] transition-colors hover:text-white border-r border-[#333]">Contribute</a>
            <a href="/#faq" className="flex items-center px-5 py-3.5 text-[0.95rem] text-[#a3a3a3] transition-colors hover:text-white border-r border-[#333]">FAQ</a>
            <a href="https://github.com/pradhan-not-found/Iconary" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-6 py-3.5 text-[0.95rem] font-bold tracking-widest text-black bg-white transition-opacity hover:opacity-80 font-display">
              ...
              GitHub
              {stars !== null && (
                <span className="flex items-center gap-1.5 text-[0.8rem] text-[#606060]">
                  <svg viewBox="0 0 16 16" width="12" height="12" fill="currentColor" className="text-[#eab308]"><path d="M8 .25a.75.75 0 01.673.418l1.882 3.815 4.21.612a.75.75 0 01.416 1.279l-3.046 2.97.719 4.192a.75.75 0 01-1.088.791L8 12.347l-3.766 1.98a.75.75 0 01-1.088-.79l.72-4.194L.818 6.374a.75.75 0 01.416-1.28l4.21-.611L7.327.668A.75.75 0 018 .25z"></path></svg>
                  {stars}
                </span>
              )}
            </a>
      ...
      <footer className="w-full border-t border-[#333] bg-[#1a1a1a]">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="flex flex-col gap-4 border border-[#333] px-6 py-6 md:flex-row md:items-center md:justify-between">
            ...
            <p className="text-[0.9rem] font-display font-normal text-[#555]">Iconary - Open source icons for AI, ML & data tooling</p>
          </div>
        </div>
      </footer>
    </div>
